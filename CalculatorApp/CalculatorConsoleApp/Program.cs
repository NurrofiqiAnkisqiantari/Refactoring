...
namespace CalculatorConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Hasil Penambahan : {0} * {1} = {2}", a, b, cal.Perkalian(a, b));
            Console.WriteLine("Hasil Penambahan : {0} / {1} = {2}", a, b, Calculator.Pembagian(a, b));
            Console.WriteLine("Hasil Pangkat : {0} ^ {1} = {2}", a, b, cal.Perkalian(a, b));
            Console.WriteLine("Hasil Modulo : {0} % {1} = {2}", a, b, Calculator.Pembagian(a, b));
